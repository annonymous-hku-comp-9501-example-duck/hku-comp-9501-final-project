...
python finetuning_vlm/train.py \
resume=1 \
debug=0 \
...
if __name__ == "__main__":
    exp_folder_name = "01_DriveLMv2_RT2"
    exp_name = (  #'05_num_workers_comparison_after_np_dataset_change' #"03_normalize_image_train_val"
        "09_past_traj_actionQA_template"  # "02_hyperparameter_comparison_num_frames1"
    )
    job_name = "drivelm_QAtemplate"
